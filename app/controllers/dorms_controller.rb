class DormsController < ApplicationController
  ...
  private
    ...
    def get_available_students
      ...
      @students = Student.joins(:user).select('users.first_name, users.last_name, users.email, students.*').order(":by_first_name").where('has_completed_form').where('has_participated == f')
    end
